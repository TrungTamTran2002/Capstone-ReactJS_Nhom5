...
const Header = () => {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600 shadow-lg">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          <img
            src="https://topdev.vn/blog/wp-content/uploads/2017/10/react2.png"
            className="h-8"
            alt="Flowbite Logo"
          />
